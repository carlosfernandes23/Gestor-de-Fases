...
{   
    ...
    public partial class labelnomeficheiro: Form
    {
        ...
        private void InsertTextToPdfA4()
        {
            ...
            string classeexSafe = string.IsNullOrEmpty(Classeex) ? "" : Classeex;
            string grauprepSafe = string.IsNullOrEmpty(Grauprep) ? "" : Grauprep;
            ...
            using (Stream newpdfStream = new FileStream(newFileName, FileMode.Create, FileAccess.ReadWrite))
            {
                ...
                BaseFont fontNormal = BaseFont.CreateFont("arial.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
                BaseFont fontBold = BaseFont.CreateFont("arialbd.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
                ...
                pdfContentByte.ShowTextAligned(PdfContentByte.ALIGN_LEFT, classeexSafe, 88, 50, 0);
                pdfContentByte.ShowTextAligned(PdfContentByte.ALIGN_LEFT, grauprepSafe, 85, 20, 0);
        ...
        private void InsertTextToPdfA3()
        {
            ...
            using (Stream newpdfStream = new FileStream(newFileName, FileMode.Create, FileAccess.ReadWrite))
            {
                ...
                pdfContentByte.SetFontAndSize(fontBold, 10);
                pdfContentByte.ShowTextAligned(PdfContentByte.ALIGN_LEFT, classeexSafe, 683, 50, 0);
                pdfContentByte.ShowTextAligned(PdfContentByte.ALIGN_LEFT, grauprepSafe, 680, 20, 0);
